...
(defn collection
  [name]
  (str "com.etzhayyim.kanae." name))

(def cell-specs {
  :flow_assembler {:legacy-cell "flow-assembler"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "flow_assembler")]
     :required-gates common-gates
     :trigger "manifest cell flow_assembler"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :intergov_flow {:legacy-cell "intergov-flow"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "intergov_flow")]
     :required-gates common-gates
     :trigger "manifest cell intergov_flow"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :flow_narrative {:legacy-cell "flow-narrative"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "flow_narrative")]
     :required-gates common-gates
     :trigger "manifest cell flow_narrative"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :viz_compiler {:legacy-cell "viz-compiler"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "viz_compiler")]
     :required-gates common-gates
     :trigger "manifest cell viz_compiler"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :publish {:legacy-cell "publish"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "publish")]
     :required-gates common-gates
     :trigger "manifest cell publish"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
})
